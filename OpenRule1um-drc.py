...
# ver1.00 : 2017/2/10: akita11 akita@ifdl.jp
...
geomSpace(NWL, Ndiff, "NWL-Ndiff space < 3.0")
geomSpace(Pdiff, DM_nscn, "Pdiff-NScont space < 1.5")
geomSpace(Ndiff, DM_pscn, "Ndiff-PScont space < 1.5")
...
geomSpace(Diff, DM_pcn, 1, "Diff-pcont space < 1.0")
...
geomSpace(ML1, DM_dcnt, 1, "ML1-dcont space < 1.0")
geomSpace(ML1, DM_pcnt, 1, "ML1-pcont space < 1.0")
geomSpace(ML1, DM_nscnt, 1, "ML1-nsubcont space < 1.0")
geomSpace(ML1, DM_pscnt, 1, "ML1-psubcont space < 1.0")
...
DM_via1_dcont = geomAnd(DM_via1, DM_dcont)
geomArea(DM_via1_via2, 0, 0, "via1-dcont overlap")
DM_via1_pcont = geomAnd(DM_via1, DM_pcont)
...
DMcnt1 = geomOr(DM_dcnt, DM_pcnt)
DMcnt2 = geomOr(DMcnt1, DM_nscnt)
DMcnt = geomOr(DMcnt2, DM_pscnt)
SAcnt = geomAnd(CNT, geomNot(DMcnt))
geomArea(SACcnt, 0, 0, "Stand alone Cont")
SAvia1 = geomAnd(VIA1, geomNot(DM_via1))
geomArea(SACvia1, 0, 0, "Stand alone VIA1")
SAvia2 = geomAnd(VIA2, geomNot(DM_via2))
geomArea(SACvia2, 0, 0, "Stand alone VIA1")
